...
8. Hook references remain canonical (`19 hook events`) in presentation-facing content
...
- Hook-event references drifted across files. Treat `19 hook events` as canonical and sync all docs in the same run.
